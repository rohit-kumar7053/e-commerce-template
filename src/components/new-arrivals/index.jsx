        ...
        <section>
            <div className="my-12">
                <div className="inline-flex items-center justify-center w-full">
                    <hr className="w-full h-0.5 mx-16 ml-20 bg-gray-600"></hr>
                    <span className="absolute px-28 -translate-x-1/2 bg-white left-1/2 text-xl font-bold tracking-wide text-center text-black ">
                        NEW ARRIVALS
                    </span>
                </div>
                <a
